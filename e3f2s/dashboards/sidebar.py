...
def load_sidebar():
    ...
    start_date = st.sidebar.date_input("Start date: ", value=None, min_value=date(selected_year, selected_month, 1),
                                   max_value=date(selected_year, selected_month, 31))

    stop_date = st.sidebar.date_input("Stop date: ", value=None, min_value=date(selected_year, selected_month, 1), max_value=date(selected_year, selected_month, 31))
    ...
    return current_view, city_name, selected_year, selected_month, start_date, stop_date
