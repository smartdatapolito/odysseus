...
const HeaderCell = /*#__PURE__*/React.forwardRef((props, ref) => {
  ...
  }, (props.sortDirection === SORT_DIRECTIONS.DESC || !props.sortDirection) && /*#__PURE__*/React.createElement(ChevronUp, {
    color: props.sortDirection ? theme.colors.contentPrimary : theme.colors.contentSecondary
  }), props.sortDirection === SORT_DIRECTIONS.ASC && /*#__PURE__*/React.createElement(ChevronDown, {
    color: props.sortDirection ? theme.colors.contentPrimary : theme.colors.contentSecondary
  }))));
});
