  ...
  _createClass(StatelessCheckbox, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(Root, _extends({
        ...
        title: title || null,
        $labelPlacement: labelPlacement
      }, sharedProps, mouseEvents, getOverrideProps(RootOverride)), (labelPlacement === 'top' || labelPlacement === 'left') && labelComp, this.isToggle() ? /*#__PURE__*/React.createElement(ToggleTrack, _extends({
        role: "checkbox",
        "aria-checked": isIndeterminate ? 'mixed' : checked,
        "aria-invalid": error || isError || null
      }, sharedProps, getOverrideProps(ToggleTrackOverride)), /*#__PURE__*/React.createElement(Toggle, _extends({}, sharedProps, getOverrideProps(ToggleOverride)), /*#__PURE__*/React.createElement(ToggleInner, _extends({}, sharedProps, getOverrideProps(ToggleInnerOverride))))) : /*#__PURE__*/React.createElement(Checkmark, _extends({
        role: "checkbox",
        checked: checked,
        "aria-checked": isIndeterminate ? 'mixed' : checked,
        "aria-invalid": error || isError || null
      }, sharedProps, getOverrideProps(CheckmarkOverride))), /*#__PURE__*/React.createElement(Input, _extends({
        value: value,
        name: name,
        checked: checked,
        required: required,
